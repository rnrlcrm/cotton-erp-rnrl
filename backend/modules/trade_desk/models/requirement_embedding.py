...
class RequirementEmbedding(Base):
    """
    Vector embeddings for requirements - enables semantic search.
    
    Generated from:
    - Commodity name + quality parameters
    - Delivery preferences
    - Buyer intent and preferences
    ...
    # Foreign Key (one-to-one with Requirement)
    ...
    def __repr__(self) -> str:
        return f"<RequirementEmbedding(id={self.id}, requirement_id={self.requirement_id})>"
